...
public class NewsCompositionAction extends ActionSupport implements RequestAware, SessionAware, Serializable {
    ...
    private Map<Integer, String> mapAccess = new HashMap<Integer, String>();
        ...
        private List<String> listImagePosition = new ArrayList<String>();
    ...
    public String NewsComposition_new() throws Exception {
        ...
        requestáttributes.put("page", "/WEB-INF/views/newsCompositionEdit.jsp");
        return "NEW";
    }
