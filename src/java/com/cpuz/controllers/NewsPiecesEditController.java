...
public class NewsPiecesEditController extends GenericEditController {
    ...
    protected NewsPiecesService npvm = new NewsPiecesService();
    private NewsCompositionsService ncvm = new NewsCompositionsService();
    private InfoBlocksService inbvm = new InfoBlocksService();
    private ImagesService imgvm = new ImagesService();
