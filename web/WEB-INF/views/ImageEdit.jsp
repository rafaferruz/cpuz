...
<s:if testá"control.runAction == 'edit'" >
    <h3 align="center"><s:text name="ImageEdition"/></h3>
</s:if>

<s:if testá"control.runAction == 'new'" >
    <h3 align="center"><s:text name="ImageMailBox"/></h3>
    <ul>
        <li><s:text name="ImageEditFull_Msg1"/></li>
        <li><s:text name="ImageEditFull_Msg2"/></li>
    </ul>
</s:if>
<br/>
...
<s:form id="image_form" name="image_form" enctype="multipart/form-data"
            ...
            <table  class="form_data" align="right" >
                <tr>
                    ...
                    <td align="center"><s:submit type="button" name="guardar"
                              ...
                              onClick="check_image_form()" theme="simple"/></td>
                </tr>
            </table>
        </td>
    </tr>
...
<script type="text/javascript">
    ...
    function orden_ejecutar(accion) {
        window.document.image_form.runAction.value = accion;
        window.document.image_form.action = "Image_"+accion+".action";
        window.document.image_form.submit();
    }

    function check_image_form(){
        mensaje=""
        if (document.image_form.userReference.value.length==0){
        ...
        if (mensaje.length!=0){
            ...
            alert(mensaje)
            document.image_form.nombre.focus();
            return 0;
        } else {
