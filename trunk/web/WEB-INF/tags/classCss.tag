...
<c:choose>
	<c:when test="${style == 'Titular'}">
		class='${prefix}compositionTitular'
	</c:when>
	...
	<c:when test="${style == 'compositionAbstract'}">
		class='${prefix}compositionAbstract'
	</c:when>
	<c:when test="${style == 'compositionDate'}">
		class='${prefix}compositionDate'
	</c:when>
	<c:when test="${style == 'composition'}">
